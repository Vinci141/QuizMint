...
const Sidebar: React.FC<SidebarProps> = ({ currentDifficulty, onDifficultyChange, topic, onTopicChange }) => {
  return (
    <aside className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-2xl flex flex-col space-y-8">
      <div>
        ...
        <div className="flex items-center justify-between">
            ...
            <button 
                ...
                className="text-xs text-slate-400 hover:text-sky-400 transition-colors ml-2"
            >
                Edit
            </button>
        </div>
